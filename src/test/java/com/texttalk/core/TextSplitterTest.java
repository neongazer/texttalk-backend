...
public class TextSplitterTest {
    ...
    private final static Logger logger = LoggerFactory.getLogger(TextSplitterTest.class);
    ...
    public void testTextSplit() {
        List<String> splittedText = TextSplitter.splitText("Aaaa      bbbbb   cccccccc asashdgadxxxxxxxxxssssssssssswwwwwwwwwww jashd llaksjd klaksjd klla 111 222 333",
                20
        );
    ...
    public void testTextSplit2() {
        List<String> splittedText = TextSplitter.splitText("Leidinys rengiamas Nacionalinės bibliografijos duomenų " +
